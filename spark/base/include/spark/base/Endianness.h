...
#       define BIG_ENDIAN
#   elif defined(__LITTLE_ENDIAN) && (__BYTE_ORDER == __LITTLE_ENDIAN) && !defined(LITTLE_ENDIAN)
...
#       define LITTLE_ENDIAN
#else
#   if defined(__ARMEL__) || defined(__THUMBEL__) || defined(__AARCH64EL__) || defined(_MIPSEL) || defined(__MIPSEL) || defined(__MIPSEL__) || defined(__ia64__) || defined(_IA64) ||   \
       defined(__IA64__) || defined(__ia64) || defined(_M_IA64) || defined(__itanium__) || defined(i386) || defined(__i386__) || defined(__i486__) || defined(__i586__) ||              \
       defined(__i686__) || defined(__i386) || defined(_M_IX86) || defined(_X86_) || defined(__THW_INTEL__) || defined(__I86__) || defined(__INTEL__) || defined(__x86_64) ||           \
       defined(__x86_64__) || defined(__amd64__) || defined(__amd64) || defined(_M_X64) || defined(__bfin__) || defined(__BFIN__) || defined(bfin) || defined(BFIN)
#   define LITTLE_ENDIAN
#   elif defined(__m68k__) || defined(M68000) || defined(__hppa__) || defined(__hppa) || defined(__HPPA__) || defined(__sparc__) || defined(__sparc) || defined(__370__) ||             \
         defined(__THW_370__) || defined(__s390__) || defined(__s390x__) || defined(__SYSC_ZARCH__)
#       define BIG_ENDIAN
#   elif defined(__arm__) || defined(__arm64) || defined(__thumb__) || defined(__TARGET_ARCH_ARM) || defined(__TARGET_ARCH_THUMB) || defined(__ARM_ARCH) || defined(_M_ARM) || defined(_M_ARM64)
...
#   include <cstdint>
    ...
    {
        return ((value & 0xFF00000000000000u) >> 56u) | ((value & 0x00FF000000000000u) >> 40u) | ((value & 0x0000FF0000000000u) >> 24u) | ((value & 0x000000FF00000000u) >> 8u) |
            ((value & 0x00000000FF000000u) << 8u) | ((value & 0x0000000000FF0000u) << 24u) | ((value & 0x000000000000FF00u) << 40u) | ((value & 0x00000000000000FFu) << 56u);
    }
#endif
