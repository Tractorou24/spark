...
#define SPARK_SER_DETAILS_SERIALIZE_RTTI_CLASS(ClassName, ...)                                                                                                                  \
    ...
    {                                                                                                                                                                           \
        ...
        {                                                                                                                                                                       \
            ...
            BOOST_PP_IF(BOOST_PP_VARIADIC_SIZE(__VA_ARGS__), BOOST_PP_SEQ_FOR_EACH(SPARK_SER_DETAILS_SERIALIZE, _, BOOST_PP_VARIADIC_TO_SEQ(__VA_ARGS__)), BOOST_PP_EMPTY())    \
        }                                                                                                                                                                       \
                                                                                                                                                                                \
        static void deserialize(SerializerType& serializer, ClassName& obj)                                                                                                     \
        {                                                                                                                                                                       \
            ...
            BOOST_PP_IF(BOOST_PP_VARIADIC_SIZE(__VA_ARGS__), BOOST_PP_SEQ_FOR_EACH(SPARK_SER_DETAILS_DESERIALIZE, _, BOOST_PP_VARIADIC_TO_SEQ(__VA_ARGS__)), BOOST_PP_EMPTY())  \
        }                                                                                                                                                                       \
    };
}
